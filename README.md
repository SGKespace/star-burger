...
[Ссылка](https://sgkespace.ru/) на учебный сайт.
...
Установите Docker на вашу локальную машину. Вы можете загрузить Docker для вашей операционной системы с официального сайта Docker.
...
Создайте файл .env в каталоге star_burger/  .
...
ss -ltnp
```
Откройте сайт в браузере по адресу сервера. Если всё настроено правильно, вы должны увидеть домашнюю страницу сайта "Star Burger".
[Мой сайт будет жить только на врремя проверки](http://37.228.117.169/)
