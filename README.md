...
- `YANDEX_API_KEY` - API KEY для работы с геокодером, [кабинет разработчика](https://developer.tech.yandex.ru/) для бесплатной работы выберите "JavaScript API и HTTP Геокодер".
